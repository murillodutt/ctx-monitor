...
## Scope
This policy applies to the `ctx-monitor` plugin and all scripts/agents contained in this repository.

## Redacting Sensitive Data
Always use the `anonymizer.py` script before sharing diagnostic bundles or logs in public Issues.
